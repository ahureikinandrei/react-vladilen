...
export function auth(email, password, isLogin) {
  return async (dispatch) => {
    ...
    let url =
      "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDMKL-m4P2rQXy8b-Qndt37PoHkcgndvDE";

    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDMKL-m4P2rQXy8b-Qndt37PoHkcgndvDE";
    }
